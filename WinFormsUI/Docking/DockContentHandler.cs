...
namespace TickDream.WinUI.Docking
{
    ...
    public delegate bool CloseConfirmCallBack();
    ...
    public class DockContentHandler : IDisposable, IDockDragSource
    {
        ...
        private CloseConfirmCallBack m_closeConfirmCallBack = null;
        public CloseConfirmCallBack CloseConfirmCallBack
        {
            get { return m_closeConfirmCallBack; }
            set { m_closeConfirmCallBack = value; }
        }
